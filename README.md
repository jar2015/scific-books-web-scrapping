...
# Files
- [Pyhon Code](https://github.com/jar2015/scific-books-web-scrapping/tree/master/src): it contains the code where the BookRix site is web scraped to extract data related to the name of the book, the author, language, number of visits, times the book has been marked as a favorite; to finally create a csv file. 
